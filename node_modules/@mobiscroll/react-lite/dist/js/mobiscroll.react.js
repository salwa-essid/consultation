(function (global, factory) {
  ...
  function testTouch(e, elm) {
    if (e.type == 'touchstart') {
      $$1(elm).attr('data-touch', '1');
    } else if ($$1(elm).attr('data-touch')) {
      $$1(elm).removeAttr('data-touch');
      return false;
    }
  ...
  function getCssClass(s) {
    var baseTheme = mobiscroll.themes.form[s.theme].baseTheme;
  ...
  var SliderBase = function SliderBase(elm, settings, inherit) {
    ...
    that.__init = function () {
      ...
      $listener = $parent.find(multiple ? '.mbsc-slider-handle-cont' : '.mbsc-progress-cont'); // Attach events
  ...
  var Frame = function Frame(el, settings, inherit) {
    ...
    function onBtnStart(ev) {
      ...
      if (ev.type === 'mousedown') {
        ...
        $$1(document).on('pointerup', onBtnEnd);
      }
    }
    ...
    function onBtnEnd(ev) {
      ...
      if (ev.type === 'mouseup') {
        ...
        $$1(document).off('pointerup', onBtnEnd);
      }
    }
    ...
    function insertMarkup(prevAnim, prevFocus) {
      ...
      }).on('touchstart mousedown pointerdown', '.mbsc-fr-btn-e', onBtnStart).on('touchend', '.mbsc-fr-btn-e', onBtnEnd); // Need event capture for this
    ...
    that._destroy = function () {
      ...
      $elm.off('.mbsc'); // Remove all events from elements
